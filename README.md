...
<p align="center">
  <img src="docs/assets/screenshot-overview.png" alt="Overview: latest draw, overdue tests and trend charts" width="49%">
  <img src="docs/assets/screenshot-test.png" alt="One test over time, with trend and next-test estimate" width="49%">
</p>
<p align="center"><sub>Sample data only — an invented type 2 diabetes patient
generated by <code>demo/make_demo_db.py</code>. No real records, no real dates.</sub></p>
